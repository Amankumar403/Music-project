...
import 'package:ghost_music_app/view_model/view_songs_models/albums_view_models.dart';
import '../../../common_color/color_extension.dart';
import '../../../common_widget/song_widget/album_song_rom.dart';
        ...
        child: Column(
          children: [
            ...
            ListView.builder(
                ...
                shrinkWrap: true,
                padding: const EdgeInsets.only(bottom: 10,left: 8,right: 15),
